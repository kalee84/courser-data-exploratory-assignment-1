...
## plot
with(data.sub, plot(date.time, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering"))
with(data.sub, lines(date.time, Sub_metering_2, col = "black"))
with(data.sub, lines(date.time, Sub_metering_2, col = "red"))
with(data.sub, lines(date.time, Sub_metering_3, col = "blue"))
